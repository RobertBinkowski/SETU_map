...
class Layout
{
    ...
    {
        $sql = "SELECT * FROM layout WHERE `enabled`='1'";
    ...
    {
        $sql = "INSERT INTO layout (enabled ,name, abbreviation, info, size) VALUES (enabled,:name, :abbreviation, :info, :size)";
    ...
    {
        $sql = "UPDATE layout SET name = :name, abbreviation = :abbreviation, info = :info, enabled = :enabled, size = :size WHERE ID =:ID";
    ...
    {
        $sql = "UPDATE layout SET enabled = :enabled WHERE ID =:ID";

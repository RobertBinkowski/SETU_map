...
REPLACE INTO `campuses` (`id`, `enabled`, `coordinates`, `details`) VALUES
	(1, 1, 1, NULL),
	(2, 1, 2, NULL);
...
REPLACE INTO `coordinates` (`id`, `latitude`, `longitude`, `altitude`) VALUES
	(1, 52.82735955046092, -6.935937131753209, 0),
	(2, 52.33433625797347, -6.471905235004469, 0),
	(3, 52.828140836704954, -6.936068163719749, 0);
...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  KEY `FK_images_details` (`details`),
  CONSTRAINT `FK_images_details` FOREIGN KEY (`details`) REFERENCES `details` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

REPLACE INTO `images` (`id`, `enabled`, `src`, `name`, `details`) VALUES
	(1, 1, 'images/image.png', NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=11365 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `privileges` (
  ...
  CONSTRAINT `FK_privileges_value` FOREIGN KEY (`users`) REFERENCES `value` (`id`),
  CONSTRAINT `FK_privileges_value_2` FOREIGN KEY (`logs`) REFERENCES `value` (`id`),
  CONSTRAINT `FK_privileges_value_3` FOREIGN KEY (`searches`) REFERENCES `value` (`id`),
  CONSTRAINT `FK_privileges_value_4` FOREIGN KEY (`details`) REFERENCES `value` (`id`),
  CONSTRAINT `FK_privileges_value_5` FOREIGN KEY (`images`) REFERENCES `value` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
REPLACE INTO `rooms` (`id`, `enabled`, `type`, `building`, `details`, `location`, `floor`) VALUES
	(1, 1, 'room', 6, NULL, 7, 2),
	(2, 1, 'room', 5, NULL, 1, NULL),
	(3, 1, 'room', 2, NULL, 3, NULL),
	(4, 1, 'room', 4, NULL, 2, NULL);
...
REPLACE INTO `users` (`id`, `enabled`, `email`, `name`, `password`, `created`, `campus`, `privileges`) VALUES
	(1, 1, 'test@test.com', '', 'pass', '2023-01-08', 1, NULL),
...
REPLACE INTO `value` (`id`, `name`) VALUES
	(1, 'none'),
	(2, 'read'),
	(3, 'write');

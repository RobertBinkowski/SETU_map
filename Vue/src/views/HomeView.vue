<template>
  <main>
    <SearchComponent v-if="campuses" :rooms="rooms" :buildings="buildings" :campuses="campuses"
      @selectLocation="toggleNavigationPanel" @updateSelectedCampus="handleSelectedCampusUpdate"></SearchComponent>
    <NavigationPanel v-if="navigationPanelOpen" :location="location" :locations="locations" :connections="connections"
      :entrance="campus.entrance" @updatePath="handleUpdatePath" @close="toggleNavigationPanel"></NavigationPanel>
    <MapParentComponent v-if="locations" :locations="rooms" :campus="this.campus" :path="path"
      @selectLocation="toggleNavigationPanel"></MapParentComponent>
  </main>
</template>
